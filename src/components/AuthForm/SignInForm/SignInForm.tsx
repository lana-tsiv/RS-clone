     ...
     <Input
      ...
      />
       <div className={style.errorWrapper}>
        {formError && <ErrorLabel isFormLabel errorText='Email or password are wrong'/>}
      </div>
      <Button
        clickHandler={handleSubmit(handleSendSignIn)}
        text='Sign In'
      />

      <div className={style.redirectWrapper}>Dont have an account? 
        <span 
          onClick={toggleForm}
